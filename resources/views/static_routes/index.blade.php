                ...
                <table class="table table-hover table-striped" style="text-align:center" id="dt">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><label class="badge badge-success">Established</label></td>
                            @else
                            <td><label class="badge badge-danger">Not established</label></td>
                            @endif
                            <td>
